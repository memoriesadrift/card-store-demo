...
class CustomerCrud extends Component {
    ...
    async deleteCustomer() {
        ...
        await fetch(apiUri).then(alert('Deleted Customer ' + this.state.cachedDcino + ' !')).then(window.location.href = "http://wwwlab.cs.univie.ac.at/~sulovskys00/card-store/customers");
    }
