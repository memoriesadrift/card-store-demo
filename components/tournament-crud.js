...
class TournamentCrud extends Component {
    ...
    async deleteTournament() {
        ...
        await fetch(apiUri).then(alert('Deleted Tournament ' + this.state.registryno + ' !')).then(window.location.href = "http://wwwlab.cs.univie.ac.at/~sulovskys00/card-store/tournaments");
    }
